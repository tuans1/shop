...
<body>
 ...
 -->
                                        ...
                                        <div class="w3l-table-info">
                                            ...
                                            <table id="table">
                                                ...
                                                <tbody>
													...
													<tr class="info" id="{{$item->id}}" data-product='<?php echo $item; ?>'>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <span>
																<a class="agile-icon edit"  href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil-square-o"></i></a>
                                                              
                                                            </span>
                                                            <span>
                                                                <a class="agile-icon" href="#" data-toggle="modal"
                ...
                <div class="copyrights">
                    <p>© 2018 N5QPT. All Rights Reserved Design by <a href="http://w3layouts.com/"
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu">
                <ul id="menu">
                    ...
                    <li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Khác</span> <span
