	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index1">Trang chủ</a><i class="fa fa-angle-right"></i>Đơn hàng</li>
				</ol>
		...
		<table id="table">
			...
			<tbody>
				<tr class="danger">
					<td>1</td>
					<td>Trần Văn Hùng</td>
					<td>83, An Dương Vương, P4, Q5</td>
					<td>09047383221</td>
					<td>17/05/2018</td>
					<td>Chưa giao</td>
					<td style="text-align: center;"><a class="agile-icon" href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil-square-o"></i></a></td>
				</tr>
				<tr class="danger">
					<td>2</td>
					<td>Trần Hạnh</td>
					<td>1, Nguyễn Thị Minh Khai, P4, Q5</td>
					<td>09047383221</td>
					<td>07/05/2018</td>
					<td>Chưa giao</td>
					<td style="text-align: center;"><a class="agile-icon" href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil-square-o"></i></a></td>
				...
				<tr class="info">
					<td>3</td>
					<td>Nguyễn Long</td>
					<td>234, An Dương Vương, P4, Q5</td>
					<td>09047383221</td>
					<td>02/05/2018</td>
					<td>Đang giao</td>
					<td style="text-align: center;"><a class="agile-icon" href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil-square-o"></i></a></td>
				...
				<tr class="success">
					<td>7</td>
					<td>Trần Văn Kiên</td>
					<td>123, An Dương Vương, P4, Q5</td>
					<td>09047383221</td>
					<td>11/04/2018</td>
					<td>Đã giao</td>
					<td style="text-align: center;"><a class="agile-icon" href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil-square-o"></i></a></td>
