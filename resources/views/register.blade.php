						...
						<form action="customer" method="post">
							...
							<fieldset>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" placeholder="Nhập DHP" id="username" class="input-xlarge" name="username" required>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									<input tabindex="3" class="btn btn-primary large" type="submit" id="submit" onclick="validate()" value="Đăng nhập">
									<hr>
						...
						<form action="newcustomer" method="post" class="form-stacked">
							<fieldset>
								<div class="control-group">
									<label class="control-label">Tên đăng nhập</label>
									<div class="controls">
										<input type="text" placeholder="Nhập DHP" class="input-xlarge"
								...
								<div class="control-group">
									<label class="control-label">Mật khẩu:</label>
									<div class="controls">
										<input type="password" placeholder="Nhập DHP" class="input-xlarge" id="password1" name="password" required>
									</div>
								</div>							                            
								<hr>
